...
import WebGLImageFilter from './webgl-image-filter'
...
// Scott Symbols
const _imageAugmentations = Symbol('imageAugmentations')
const _imageFilters = Symbol('imageFilters')
...
class VolumeImageViewer {
  ...
  constructor (options) {
    ...
    // this[_imageFilters] = new WebGLImageFilter();
    /* End Scott Changes */
    ...
    this[_map] = new Map({
      layers,
      view,
      controls: [new FullScreen({source: 'content-and-tools'})],
